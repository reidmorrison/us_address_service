defmodule USAddress.Nif do
  ...
  def init(_data_path) do
    raise "NIF init/1 not implemented"
  end

  def version(_handle) do
    raise "NIF version/1 not implemented"
  end

  def verify_c(_handle, _address_map) do
    raise "NIF verify_c/2 not implemented"
  end

  def verify(handle, address_map) do
    verify_c(handle, cleanse_map(address_map))
  end
